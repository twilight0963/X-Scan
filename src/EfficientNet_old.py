from tensorflow import Model, layers
...
def preprocess_image(img):
    ...
    clahe_img = clahe_img.astype(np.float16) / 255.
    return clahe_img

def efficientnet_model():
    base_model = EfficientNetB1(input_shape=(IMG_SIZE, IMG_SIZE, 3), include_top=False, weights="imagenet")
...
if __name__ == "__main__":
    ...
    try:
        ...
        model.save(os.path.join('models', 'efficientnet_model_final2.keras'))
